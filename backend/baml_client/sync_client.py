...
class BamlSyncClient:
    ...
    def CategorizeOnly(self, title: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="CategorizeOnly", args={
                "title": title,
            })
    ...
    def ClassifyProfiles(self, profiles: typing.List["types.ProfileInput"],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ClassifyProfiles", args={
                "profiles": profiles,
            })
    ...
    def ExtractLinks(self, emailHtml: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractLinks", args={
                "emailHtml": emailHtml,
            })
    ...
    def SelectProductLink(self, productName: str,productDescription: str,candidates: typing.List["types.SearchCandidate"],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="SelectProductLink", args={
    ...
    def SummarizeAndCategorize(self, title: str,content: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="SummarizeAndCategorize", args={
...
class BamlStreamClient:
    ...
    def CategorizeOnly(self, title: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="CategorizeOnly", args={
            "title": title,
        })
        return baml_py.BamlSyncStream[stream_types.CategorizeOnlyResult, types.CategorizeOnlyResult](
          __result__,
    ...
    def ClassifyProfiles(self, profiles: typing.List["types.ProfileInput"],
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ClassifyProfiles", args={
            "profiles": profiles,
        })
        return baml_py.BamlSyncStream[typing.List["stream_types.ProfileVerdict"], typing.List["types.ProfileVerdict"]](
          __result__,
    ...
    def ExtractLinks(self, emailHtml: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractLinks", args={
            "emailHtml": emailHtml,
        })
        return baml_py.BamlSyncStream[typing.List["stream_types.ExtractedLink"], typing.List["types.ExtractedLink"]](
          __result__,
    ...
    def SelectProductLink(self, productName: str,productDescription: str,candidates: typing.List["types.SearchCandidate"],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.ProductLinkChoice, types.ProductLinkChoice]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="SelectProductLink", args={
            "productName": productName,"productDescription": productDescription,"candidates": candidates,
        })
        return baml_py.BamlSyncStream[stream_types.ProductLinkChoice, types.ProductLinkChoice](
          __result__,
    ...
    def SummarizeAndCategorize(self, title: str,content: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.SummarizeAndCategorizeResult, types.SummarizeAndCategorizeResult]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="SummarizeAndCategorize", args={
            "title": title,"content": content,
        })
        return baml_py.BamlSyncStream[stream_types.SummarizeAndCategorizeResult, types.SummarizeAndCategorizeResult](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def CategorizeOnly(self, title: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="CategorizeOnly", args={
            "title": title,
        }, mode="request")
        return __result__
    def ClassifyKind(self, title: str,url: str,summary: typing.Optional[str] = None,
    ...
    def ClassifyProfiles(self, profiles: typing.List["types.ProfileInput"],
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ClassifyProfiles", args={
            "profiles": profiles,
        }, mode="request")
        return __result__
    def ExtractLinks(self, emailHtml: str,
    ...
    def SummarizeAndCategorize(self, title: str,content: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="SummarizeAndCategorize", args={
            "title": title,"content": content,
        }, mode="request")
        return __result__
